...
# Author  : By Joesatria22
# (C) Copyright 2021-2022 By Joesatria22 X GASHAKVPN
# =========================================
...
echo -e "         OWNER : ${GREEN}Joesatria22 VPN ${NC}${YELLOW}(${NC} ${GREEN}Joesatria22 VPN ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By Joesatria22 VPN ${YELLOW}(${NC} 2021-2022 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
